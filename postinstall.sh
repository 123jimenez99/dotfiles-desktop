...
sudo apt install -y --no-install-recommends mpv git streamlink ntfs-3g gamemode mangohud mangohud:i386
...
libdbus-1-3:i386 libsqlite3-0:i386 libvulkan1 libvulkan1:i386 nvidia-driver-libs:i386
